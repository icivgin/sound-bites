			...
			$.get('https://developer.echonest.com/api/v4/artist/terms?api_key=' + apiKey + '&name=' + artistName + '&format=json', function(data) {
				...
				if (data.response.terms[0]) {	
					...
					$.get('/v1/search/' + genre1 + '/' + genre2, function (data) {
						...
						$.get('https://api.foursquare.com/v2/venues/explore?client_id=' + clientID + '&client_secret=' + clientSecret + '&v=20130815%20&ll=' + '41.8369' + ',' + '-87.6847' + '&llAcc=10000.0&radius=10000&limit=10&query=' + data, function (data) {
